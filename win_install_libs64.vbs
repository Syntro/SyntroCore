...
Sub CopyLibs
	...
	srcFile = SyntroDir + "/SyntroCore/BuildLibs/x64/Debug/SyntroControlLibd.lib"
	If fso.FileExists(srcFile) Then
	    fso.CopyFile srcFile, dstFolder
		haveDebug = True
	End If

	srcFile = SyntroDir + "/SyntroCore/BuildLibs/x64/Release/SyntroControlLib.lib"
	If Not fso.FileExists(srcFile) Then
	    If Not haveDebug Then
			MsgBox srcFile + " not found", vbOkOnly, "Copy Error"
			Exit Sub
...
Sub CopyDLLs()
	...
	srcFile = SyntroDir + "/SyntroCore/BuildLibs/x64/Debug/SyntroLibd.dll"
	If fso.FileExists(srcFile) Then
	    fso.CopyFile srcFile, dstFolder
		haveDebug = True
	End If

	srcFile = SyntroDir + "/SyntroCore/BuildLibs/x64/Release/SyntroLib.dll"
	If Not fso.FileExists(srcFile) Then
		If Not haveDebug Then
			MsgBox srcFile + " not found", vbOkOnly, "Copy Error"
			Exit Sub
	...
	srcFile = SyntroDir + "/SyntroCore/BuildLibs/x64/Debug/SyntroControlLibd.dll"
	If fso.FileExists(srcFile) Then
	    fso.CopyFile srcFile, dstFolder
		haveDebug = True
	End If

	srcFile = SyntroDir + "/SyntroCore/BuildLibs/x64/Release/SyntroControlLib.dll"
	If Not fso.FileExists(srcFile) Then
		If Not haveDebug Then
			MsgBox srcFile + " not found", vbOkOnly, "Copy Error"
			Exit Sub
	...
	srcFile = SyntroDir + "/SyntroCore/BuildLibs/x64/Debug/SyntroGUId.dll"
	If fso.FileExists(srcFile) Then
	    fso.CopyFile srcFile, dstFolder
		haveDebug = True
	End If

	srcFile = SyntroDir + "/SyntroCore/BuildLibs/x64/Release/SyntroGUI.dll"
	If Not fso.FileExists(srcFile) Then
		If Not haveDebug Then
			MsgBox srcFile + " not found", vbOkOnly, "Copy Error"
			Exit Sub
